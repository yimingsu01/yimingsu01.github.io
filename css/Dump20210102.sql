...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='Student awards';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stud_award` VALUES (1,1,'CCC','Top 25%','2019-02-01','2020-08-08','2020-08-08',0),(2,1,'Housing price contest','Top 3%','2020-07-15','2020-08-08','2020-08-08',1);
...
INSERT INTO `stud_info` VALUES (1,'苏亦鸣','Erik','yimingsu@uchicago.edu',NULL,NULL,NULL,'2014-09-01','0115353','020101','2020-08-05',NULL,NULL,'2021-01-02 09:01:06','ahri.png',1),(2,'苏','E','abcd',NULL,NULL,NULL,'2014-09-01','0115353','020101','2020-08-05',NULL,NULL,'2020-11-16 14:39:12','ahri.png',1),(3,'亦','Er','abcd',NULL,NULL,NULL,'2014-09-01','0115353','020101','2020-08-05',NULL,NULL,'2020-11-16 14:39:12','ahri.png',1),(4,'鸣','Erik','abcd',NULL,NULL,NULL,'2014-09-01','0115353','020101','2020-08-05',NULL,NULL,'2020-11-16 14:39:12','ahri.png',1);
...
CREATE TABLE `stud_univ` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stud_id` int(11) NOT NULL,
  `univ_country` varchar(128) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='Student university choosing';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stud_univ` VALUES (1,1,'US','Uchicago',0,'1',1,'1'),(2,1,'US','Uchicago',0,'1',1,'1'),(3,1,'US','Uchicago',NULL,NULL,0,'2021-01-01 05:01:58'),(4,1,'US','Uchicago',NULL,NULL,0,'2021-01-01 05:02:09');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='Table for students violation of school regulation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stud_violation` VALUES (1,1,1,'Dating with a girl','Dating with a girl','2020-01-01','2020-01-01',NULL,0),(2,1,2,'Dating with two girls at same time','Dating with two girls at same time','2020-01-01','2020-01-01',NULL,0),(3,1,3,'Dating with three girls at same time','Dating with three girls at same time','2020-01-01','2020-01-01',NULL,0);
...
INSERT INTO `subject_class` VALUES (1,1,1,'1,2,3,4',10,12,NULL,'','2020-08-14',1),(2,1,2,'1,2,3,4',10,12,NULL,NULL,'2020-08-14',1),(3,1,3,'1,2,3,4',10,12,NULL,NULL,'2020-08-14',0),(4,1,4,'1,2,3,4',10,12,NULL,NULL,'2020-08-14',0),(5,1,5,'1,2,3,4',10,12,NULL,NULL,'2020-08-14',0),(6,1,6,'1,2,3,4',10,12,NULL,NULL,'2020-08-14',0);
...
INSERT INTO `swap_subj_application` VALUES (1,1,1,1,'Bored','2020-08-13',NULL,NULL,0),(2,1,1,1,'Nothing','2020-08-13 15:03:26',1,'2020-08-13 15:04:03',2);
...
INSERT INTO `teacher_info` VALUES (1,'苏亦鸣','Yiming Su','','020101','01153532',1,1,'2020-08-07','2020-08-13 13:25:45',0),(2,'sym','Erik','bgysym@126.com','123456','01153533',1,1,'2020-08-13 14:24:30','2020-08-13 14:24:51',0),(3,'sb','sb','sb@sb.sb','123','123',1,1,'2020-08-13 15:06:17',NULL,0);
...
-- Dump completed on 2021-01-02 16:35:48
